...
<head>
    ...
    <style>
        ...
        .bg-perpus { background-color: #3c8dbc; } /* Biru khas E-Perpus */
        .btn-black { background-color: #222d32; color: white; } /* Tombol gelap senada dengan sidebar */
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center align-items-center bg-white p-5">
            <div style="width: 100%; max-width: 400px;">
                ...
                <p class="text-muted mb-4" style="font-size: 14px;">
                    Silahkan masuk ke akun administrator Anda.
                </p>
                ...
                <form action="/login/process" method="POST">
                    <div class="mb-4">
                        <input type="email" name="email" class="form-control form-control-lg border-0 border-bottom rounded-0 px-0" 
                               placeholder="Email Administrator" required>
                    </div>
                    <div class="mb-4">
                        <input type="password" name="password" class="form-control form-control-lg border-0 border-bottom rounded-0 px-0" 
                    ...
                    <div class="text-center mt-4">
                        <a href="/lupa-password" class="text-decoration-none text-muted" style="font-size: 14px;">Forget password? <strong class="text-dark">Click here</strong></a>
                    </div>
                </form>
            </div>
        </div>
